...
<script type="text/javascript">
  function homePage(){
window.location.href="http://localhost:8080/crm_hoken/"; 
/*   top.location.href="http://localhost:8080/crm_hoken/"; */
  }
</script>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				<TR>
					...
					<TD background=images/new_002.jpg><FONT size=5><B><a style="text-decoration:none;" href="#" target="_top" onclick="homePage()">顧客情報管理システム</a></B></FONT></TD>
