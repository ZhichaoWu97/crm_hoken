			...
			<TBODY>
				<TR>
					...
					<TD align=middle width=180 background=images/new_006.jpg
						height=35><B> 機能－メニュー</B></TD>
					<TD width=15><IMG src="images/new_007.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0 height=390>
			<TBODY>
				<TR>
							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 顧客管理</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 注文管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/hoken_saveUI.action"
														target=main>－ 注文新規</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/hoken_findAll.action"
														target=main>－ 注文リスト</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN>ユーザー設定</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=menuSmall  href='${pageContext.request.contextPath }/user_edit.action?user_id=<s:property value="#session.existUser.user_id"/>' 
													target=main>－ 設定変更</A></TD>
																																				<%-- <s:property  value="#session.existUser.user_id"/> --%>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
